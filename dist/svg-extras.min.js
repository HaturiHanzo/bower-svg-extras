var svgext=function(){"use strict";if(!inherit)throw new Error("Svg-extras requires https://github.com/dfilatov/inherit");var t="ontouchstart"in document.documentElement;return{_isTouchDevice:t,_throttleEventListener:function(t,e,n){var r=!1,i=!1;n=n||window;var o=function(t){return!r&&(r=!0,void requestAnimationFrame(function(){i||e(t),r=!1}))};return n.addEventListener(t,o,!1),function(){i=!0,n.removeEventListener(t,o)}},"default":{vertexWidth:t?20:12,vertexHeight:t?20:12,borderOffset:t?16:14,polygonAddPointDist:t?20:0}}}();
