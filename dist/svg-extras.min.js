...
!function(t){"use strict";t.SVGBorderControl=inherit(t.SVGRect,{__constructor:function(){this.__base({cssClass:"svg-border-control",isDraggable:!0,width:t["default"].control.width,height:t["default"].control.height}),t._isTouchDevice&&this.addClass("svg-control_type_touch")},onAppend:function(t){this.__base(t),this.render()},normalizeCoords:function(t){var e=this.getContainerRect(),i=this.container;return i.width()+t.x<1?t.x=i.width()>1?-1*(i.width()-1):0:i.getX()+i.width()+t.x>e.width&&(t.x=e.width-i.getX()-i.width()),i.height()+t.y<1?t.y=i.height()>1?-1*i.height()+1:0:i.getY()+i.height()+t.y>e.height&&(t.y=e.height-i.getY()-i.height()),t},drag:function(t){var e=this.container;e.width(e.width()+t.x).height(e.height()+t.y)},render:function(e){var i=this.container,h=t["default"].borderedRect.borderOffset;"x"!==e&&this.setY(i.getY()+i.height()+h-t["default"].control.height/2),"y"!==e&&this.setX(i.getX()+i.width()+h-t["default"].control.width/2)}})}(svgext);
